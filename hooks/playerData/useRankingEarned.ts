...
const useRankingEarned = (checksumAddress) => {
	...
	useEffect(() => {
      ...
      {
        userStats(where: {earned_gt: 1000000000000000}, orderBy:earned, orderDirection: desc, first: 1000) 
        {
          id
          earned
        }
...
export default useRankingEarned;
